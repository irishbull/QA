package ta.test.impl.seo.categorypage1;
...
public class CategoryPage1SourceTest extends SeoSourceTest {

    @Test(dataProvider = "fetchJSONData", dataProviderClass = JSONDataProvider.class)
    @Description("<p><code>&lt;title&gt;</code></p><ul><li>esiste</li><li>il suo valore è uguale a quello atteso</li></ul>")
    public void tc_001_category_page_1_title(JSONObject testData) {
    ...
    public void tc_002_category_page_1_header1(JSONObject testData) {
    ...
    public void tc_003_category_page_1_metaDescription(JSONObject testData) {
    ...
    public void tc_004_category_page_1_relCanonical(JSONObject testData) {
    ...
    public void tc_005_category_page_1_anchor() {
