package ta.test.impl.seo.categorypage3;
...
public class CategoryPage3RenderedTest extends SeoRenderedTest {

    @Test(dataProvider = "fetchJSONData", dataProviderClass = JSONDataProvider.class)
    @Description("<p><code>&lt;title&gt;</code></p><ul><li>esiste</li><li>il suo valore è uguale a quello atteso</li></ul>")
    public void tc_001_category_page_3_title(JSONObject testData) {
    ...
    public void tc_002_category_page_3_header1(JSONObject testData) {
    ...
    public void tc_003_category_page_3_metaDescription(JSONObject testData) {
    ...
    public void tc_004_category_page_3_relCanonical(JSONObject testData) {
    ...
    public void tc_005_category_page_3_anchor(JSONObject testData) {
    ...
    public void tc_006_category_page_1_noindex(JSONObject testData) {
