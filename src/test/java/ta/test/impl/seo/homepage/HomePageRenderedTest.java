package ta.test.impl.seo.homepage;
...
public class HomePageRenderedTest extends SeoRenderedTest {

    @Test(dataProvider = "fetchJSONData", dataProviderClass = JSONDataProvider.class)
    @Description("<p><code>&lt;title&gt;</code></p><ul><li>esiste</li><li>il suo valore è uguale a quello atteso</li></ul>")
    public void tc_001_homepage_title(JSONObject testData) {
    ...
    public void tc_002_homepage_header1(JSONObject testData) {
    ...
    public void tc_003_homepage_metaDescription(JSONObject testData) {
    ...
    public void tc_004_homepage_relCanonical(JSONObject testData) {
    ...
    public void tc_005_homepage_anchor() {
    ...
    public void tc_006_homepage_noindex() {
